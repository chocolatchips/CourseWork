...
int animTcl::Tcl_AppInit(Tcl_Interp *interp)
{
	...
	//sprintf(filename, "../../Collisions_Tests/one_particle.tcl");
	//sprintf(filename, "../../Collisions_Tests/simple_spring.tcl");
	//sprintf(filename, "../../Collisions_Tests/cube_simple.tcl");
	//sprintf(filename, "../../Collisions_Tests/cube_complex.tcl");
	sprintf(filename, "../../Collisions_Tests/cube_complex_full.tcl");
	//sprintf(filename, "../../Collisions_Tests/many_particles.tcl");
